...
The total souls aboard computed above is 2201, while Wikipedia says there were 2,224 souls on board. The difference could be accounted by stowaways who managed to sneak onto the ship and so wouldn't be officially recorded by the cruise liner. Another possibility is that the cruise liner could have accidentally made an error in their records.
