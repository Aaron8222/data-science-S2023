...
- (List all variables here) The variables are class, sex, age, survived,
  and n. The options for class include 1st, 2nd, 3rd, and crew. The
  options for sex are either male or female and child and adult for age.
  The options for survived are either yes or no and n is the number of
  people who fall into each catagory listed above.
...
The total souls aboard computed above is 2201, while Wikipedia says
there were 2,224 souls on board. The difference could be accounted by
...
- Write your observations here There were many more male crew members
  who survived compared to the female crew members, while the ratio of
  female and male people in 3rd class were more or less equal. More
  females on 1st and 2nd class survived compared to the males in the
  same class.
...
From this graph, it appears all the people who were 1st class and 2nd
class survived, which is very fishy. A larger portion of the females in
3rd and crew survived compared to the males and there was a
significantly higher portion of the females who were crew members who
survived compared to the males.
...
The fishy-ness becomes more clear with the plot above. When using the
geom_col() to create bar charts, you have to be sure the x and y values
have a one to one relationship. Since we didn’t take this into account,
ggplot superimposed the adult and child bars together and all you could
see was the higher one of the two. This was fixed by separating the
adult and child data. A significant more portion of adult females
survived compared to their male counterparts. Almost 90% of female
adults survived in 1st, 2nd, and crew class and almost 50% in 3rd class.
There is a low portion of the males who survived, with the highest being
about 30% in 1st class and the lowest at about 10% in 2nd class. All
children in 1st and 2nd class survived. About 50% of the female children
and about 25% of male children in 3rd class survived.
