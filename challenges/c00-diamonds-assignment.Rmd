...
There isn't much you can tell from this graph. There appears to be a positive correlation between the price and the carat of a diamond. The price for diamonds that are 1 carat or bigger vary greatly.
...
- (Write your observations here!)
It appears the cut of a diamond does not influence the price of a diamond as much as carat does if at all. There does seem to be a linear trend line for fair cut diamonds. However, if we color code the diamonds by clarity, the relationship between price, carat, and clarity becomes more clear. The price increases with carat and clarity but not as much with the cut of a diamond.
```{r q2-tangent}
ggplot(data = diamonds) + 
