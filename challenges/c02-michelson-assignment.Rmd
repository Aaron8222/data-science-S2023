...
Differences
- There are differences in individual data points. On some days, the actual data may be clustered while the simulated data may not be and more spread out. For example, on June 23, the actual data is more together and closer to the mean (dotted line), while the simulated data a lot more.
