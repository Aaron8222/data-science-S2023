...
lo <- df_q2$stat - q95 * df_q2$stat / sqrt(n)
hi <- df_q2$stat + q95 * df_q2$stat / sqrt(n)
...
- Was your sample size $n$ large enough? Why do you say that?
  - My sample size is large enough because the range in the confidence interval is very small.
