...
- Which `subject_race` levels have terms in the model?
  - The estimated coefficients for Hispanic and white are 0.513 and -0.380, which suggests individuals who are classified as Hisplanic are more likely to get arrested and individuals are are classified as white are associated with lower arrest rates.
...
- How does controlling for found contraband affect the `subject_race` terms in the model?
  - When controlling found contraband, the subject_race coefficients decreased for black and hispanic races. However, the fitted model still suggests individuals who are Hispanic have a higher probability of getting arrested.
