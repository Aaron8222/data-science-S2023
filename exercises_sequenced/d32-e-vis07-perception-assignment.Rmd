...
Ordering the y axis by alphabetical order has no meaning in this case. It is hard to compare mpg for each manufacturer.
...
- What are some issues with this graph?
Area is pretty low on the visual hierarchy.
...
- What are some issues with this graph?
Stacked bar charts are lower on the visual hierarchy compared to a common scale.
...
- What are some issues with this graph?
Pie charts encode in angles and are lower on the visual hierarchy.
