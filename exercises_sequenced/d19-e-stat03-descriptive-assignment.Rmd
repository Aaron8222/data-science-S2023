...
The mean departure delay time is 12.6 hours.
...
EV, YV top in mean. UA, VX top in median
...
YV, EV, F9, and FL
- Which carriers differ in the two lists?
HA top in sd and 9E top in IQR
- Which carrier has the biggest difference between its `sd` and `IQR`? What might this mean?
HA has a large difference bw sd and IQR. It appears HA has a lot more outliers than other carriers
