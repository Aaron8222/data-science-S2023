...
The text is larger and there are grid lines have been flipped from white to grey.
...
mpg %>%
  ...
  theme(
    ...
    axis.title.x = element_text(margin = margin(4, 10, 4, 4), size = 16),
    axis.title.y = element_text(margin = margin(4, 4, 35, 4), size = 16, angle = 45),
    ...
    plot.margin = unit(c(t = +0, b = +15, r = +0, l = +30), "cm"),
    plot.title = element_text(size = 18),
    plot.title.position = "plot",
    plot.subtitle = element_text(size = 16),
    plot.caption = element_text(size = 12)
