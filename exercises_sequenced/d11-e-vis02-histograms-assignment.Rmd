...
mpg %>%
  ...
  geom_density()
```
The SUV class has the most vehicles. The pickup trucks has the most distribution. Vis1 helps understand raw numbers, while vis2 helps understands the distribution of car mileages in a group.
...
**Observations**
As you increase the binwidth, you see a strange pattern the number of diamonds starts extremely high at even carats such as 0.5, 0.7, or 0.9. The number of carats then decreases dramatically before shooting back up. As you decrease the binwidth, carats under 0.5 remain the highest count. 
