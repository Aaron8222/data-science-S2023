...
A line plot assumes the underlying data have a function relationship.
- How does the `mpg` dataset violate this assumption?
The mpg dataset does not have a function relation between displ and hwy
...
- What can you tell based on the `Raw` data?
  With the raw data, you can tell the rise and fall over time.
- What can you tell based on the `Smoothed` data?
  With the smoothed data, you can tell trends easier.
<!-- include-exit-ticket -->
# Exit Ticket
<!-- -------------------------------------------------- -->
