...
diamonds %>%
  select(everything()) %>%
  mutate(carat_cut = cut_number(carat, n = 10)) %>%
...
With only 3 box plots, the median price for higher carats increases, but it is not linear. There is a lot of variation in price 0.5 carats and above, however, you see less of this below 0.5 carats. With 10 box plots, you can see a clear price increase upward as the carat increases. Again, you can see more variation (denoted by the vertical lines and dots) as the carat increases.
...
The majority of diamonds above 2 carats are premium cuts with colors H, I, J, while the most common for all carats is ideal with the color G.
