...
```
The vignettes available include colwise, compatiability, base, grouping, dplyr, programming, rowwise, two-table, and window-functions.
...
You can look up help by putting a ? in front of a function with no ()
...
The cut_number comes from the ggplot2 package. The parse_number comes from readr. The row_number comes from dplyr.
