...
The arguments for rnorm() are n, mean, and sd. n is the number of observations, mean is a vector of means, and sd is a vector of standard deviations.
...
Use library() to list all available packages.
