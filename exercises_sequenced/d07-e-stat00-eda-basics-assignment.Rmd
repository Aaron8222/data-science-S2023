...
Ideal diamond cuts are in fact the most numerous out of all the diamond cuts. There are over 20,000 ideal diamond cuts, far greater than even the next greatest cut (premium at 13,000).
...
**Observations**:
- Write your observations here!
This does not relate to the hypothesis because this does not account for the other C's such as carat or clarity.
...
**Observations**:
- Write your observations here!
This graph contradicts hypothesis 2. On average, ideal cuts are slightly less expensive if not the same price as other cuts of diamonds.
...
**Observations**:
- Write your observations here!
There is some data suggesting the "carat over cut" hypothesis as can be seen between premium and ideal cuts. There is a noticeable higher carat average for premium than ideal cuts. 
